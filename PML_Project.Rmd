...
## The required datasets are downloaded from the locations specified for both training and teesting purposes

# read the csv file for training 
## There are lot of values like "NA" in the dataset which cannot be analyzed. So we need to remove those records. Also need to remove the header rows also from the dataset.
...
Examining the target variable to see its distribution.
```{r}
# Plot
